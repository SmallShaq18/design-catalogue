    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60 mb-8">No projects found in this category.</p>
          <Link
            to="/projects"
            className="inline-flex items-center gap-2 text-neonPink hover:text-hotOrange transition"
          >
            <ChevronLeft size={20} />
            Back to Projects
          </Link>
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <Link
          to="/projects"
          className="inline-flex items-center gap-2 text-neonPink hover:text-hotOrange transition mb-8"
        >
          <ChevronLeft size={20} />
          Back to Projects
        </Link>
        ...
        {/* Header *
        <div className="mb-12">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-4 capitalize">
            {category}
          </h1>
