...
export const ProjectDetails = ({ project }: ProjectDetailsProps) => {
  const hasDetails =
    project.client || project.year || project.tools || project.tags;
    ...
    <div className="mb-12 grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      {project.client && (
        <div>
          ...
          <p className="text-lg text-white">{project.client}</p>
        </div>
      )}
      ...
      {project.tools && project.tools.length > 0 && (
        <div>
          ...
          <p className="text-lg text-white">{project.tools.join(", ")}</p>
        </div>
      )}
      ...
      <div>
        ...
        <p className="text-lg text-white capitalize">{project.category}</p>
      </div>
